...
API_ID = int(environ.get('API_ID', '20340960'))
API_HASH = environ.get('API_HASH', '731d6413f609e18766e56908534d4ae2')
BOT_TOKEN = environ.get('BOT_TOKEN', "7581698581:AAGvHYnGBoh8WdKuU9CEFfL2ICf1y1332kI")
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '597083078').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002754929731'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002837208807').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002585689620') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://laiiqlaiiq033:cS9Qf578yz1nPiDD@cluster0.gytxv8c.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
